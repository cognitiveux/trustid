...
<script src="js/subscribe-upat.js"></script>
<style>
                            ...
                            <div class="team team-list clearfix">
                                <div class="team-desc">
                                    ...
                                    <div class="team-content">
										...
										<p><b>Φάση 1 (15 λεπτά, τέλη Ιανουαρίου 2022, θα ενημερωθείτε με email και οδηγίες) – Δημιουργία Υπολογιστικών Μοντέλων Ταυτοποίησης</b></p>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="team team-list clearfix">
                                <div class="team-desc">
                                    <div class="team-title">
                                        <h4>Δηλωση Συμμετοχης εκ μερους του Πανεπιστημιου Πατρων</h4>
                                    </div>
                                    <div class="team-content">
                                        <div class="row">
