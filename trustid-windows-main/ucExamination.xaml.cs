...
namespace trustid
{
    ...
    public partial class ucExamination : UserControl
    {
        ...
        public ucExamination()
        {
            ...
            dispatcherTimer.Tick += new EventHandler(monitor_activity);
            dispatcherTimer.Interval = new TimeSpan(0, 0, 10); // make a monitoring request every 30 sec.
            dispatcherTimer.Start();
            Globals.is_monitoring_active = true;
        }
